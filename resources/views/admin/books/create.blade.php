        ...
        <div class="card shadow mb-4">
            ...
            {!! Form::open(array('route' => 'books.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('author_id', App\Models\Author::pluck('name', 'id'), null,['placeholder'=>'Select author','class'=>'form-control '.($errors->has('author_id')? 'is-invalid': '')]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('category_id', App\Models\Category::pluck('name', 'id'), null,['placeholder'=>'Select category','class'=>'form-control '.($errors->has('category_id')? 'is-invalid': '')]) !!}
