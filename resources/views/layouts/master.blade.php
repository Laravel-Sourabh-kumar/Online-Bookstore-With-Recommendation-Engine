...
<head>
    ...
    <title>@yield('title', 'Online Bookstore - Home')</title>
    <!-- Favicon icon -->
...
<section class="header py-2 bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                <h3><a href="{{route('bookshop.home')}}" class="text-secondary"><b class="text-danger">Online Book</b> Store</a></h3>
                </div>
            </div>
            <div class="col-md-4">
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <div class="footer-text">
            Copyright &copy; Online Bookstore All Right Reserved. <span id="year"></span>
        </div>
